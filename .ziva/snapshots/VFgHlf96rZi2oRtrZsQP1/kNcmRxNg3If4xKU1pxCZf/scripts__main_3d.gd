...
var cam_offset: Vector3 = Vector3(0, 10, 12)
...
func _on_roll_button_pressed() -> void:
	...
	cam_offset = Vector3(0, 3.0, 4.0) # Much closer
	cam_follow_speed = 7.0 # Faster follow
	update_camera_focus()
	
	# Show dice above player
	dice_3d.global_position = player.global_position + Vector3(0, 2.5, 0)
