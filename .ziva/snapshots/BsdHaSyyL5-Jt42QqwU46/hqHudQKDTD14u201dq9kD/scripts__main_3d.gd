	...
	if start_space:
		...
		for p in [m, l]:
			if p:
				...
				p.global_position = start_space.global_position + Vector3(0, 0, 0)
...
func _ready() -> void:
	...
	if b_delete: b_delete.pressed.connect(func(): builder.select_item(7)) # Delete
...
func start_intro():
	...
	main_camera.global_position = Vector3(0, 120, 140) 
...
func _on_roll_button_pressed() -> void:
	...
	dice_3d.global_position = player.global_position + Vector3(0, 6.0, 0)
